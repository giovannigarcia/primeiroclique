...
<html>
    ...
    <body>
        ...
        "<h3>Editar tarefa <ins>".$idTarefa."</ins> do teste: <ins>" . $nomeTeste . "</ins></h3>".
        "</div>";
        ...
        <ul class="navega">
          ...
          <li><a href="#" class="active">Editar Tarefa</a></li>
          <a class="sair" href="logout.php" title="Encerra acesso"><i class="fa">&#xf08b;</i> Logout</a>
        </ul>

    <div class="center">
        <div class="inclusao">
            <form method="POST" action="salvaEditaTarefa.php" >
                Descrição: <input type="text" name="descricao" style='width:85%;' required value="<?php echo $descricao ?>"><br>
                Link: <input type="text" id="site" name="link" style='width:65%;' required value="<?php echo $link ?>">
                <?php
                ...
                <input type="button" id="cancela" value="Cancelar" onclick="javascript:document.getElementById('formulario').submit()">
               </form>
        </div> 
